...
@section('content')
    ...
    <div class="patients-container p-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <a href="{{ route('medicalTests.create') }}" class="btn btn-primary ms-3"> <!-- Left margin for Add button -->
                Add
                ...
                <tbody>
                    @foreach ($medicalTests as $medicalTest)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('medicalTests.edit', $medicalTest->id) }}"
        ...
        @include('Admin.medicalTests.delete')
