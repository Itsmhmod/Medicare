...
@section('content')
    ...
    <div class="patients-container p-3">
            ...
            <table id="myTable" class="table table-striped table-bordered text-center mx-3"> <!-- Margin added -->
                <thead>
                    <tr>
                        ...
                        <th><strong>Clinic Rate</strong></th>
                        <th><strong>Doctor Rate</strong></th>
                        <th><strong>Treatment Rate</strong></th>
                ...
                <tbody>
                    @foreach ($clientReviews as $clientReview)
                        <tr>
                            <td><strong>{{ $clientReview->id }}</strong></td>
                            <td><strong>{{ $clientReview->comment }}</strong></td>
                            <td><strong>{{ $clientReview->clinic_rate }}</strong></td>
                            <td><strong>{{ $clientReview->doctor_rate }}</strong></td>
                            <td><strong>{{ $clientReview->treatment_rate }}</strong></td>
                            <td><strong>{{ $clientReview->doctor->name }}</strong></td>
                            <td>
                                ...
                                <a href="javascript:;" class="btn btn-primary btn-sm p-2 mx-2" data-bs-toggle="modal"
                                    data-bs-target="#deleteSliderModal{{ $clientReview->id }}">
        ...
        @include('Admin.ClientReviews.delete')
