@foreach ($clientReviews as $clientReview)
    <div class="modal fade" tabindex="-1" aria-hidden="true" id="deleteSliderModal{{ $clientReview->id }}">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('clientReview.destroy', $clientReview->id) }}" method="post">
                    @csrf
                    @method('DELETE')
