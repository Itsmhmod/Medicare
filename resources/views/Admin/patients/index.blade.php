...
@section('content')
    ...
    <div class="patients-container p-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <a href="{{ route('patient.create') }}" class="btn btn-primary ms-3"> <!-- Left margin for Add button -->
                Add
                ...
                <tbody>
                    @foreach ($patients as $patient)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('patient.edit', $patient->id) }}" class="btn btn-primary btn-sm p-2 mx-2">
                                ...
                                <a href="javascript:;" class="btn btn-primary btn-sm p-2 mx-2" data-bs-toggle="modal"
                                    data-bs-target="#deleteSliderModal{{ $patient->id }}">
