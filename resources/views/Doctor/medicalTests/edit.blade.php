...
@section('content')
    <div class="card mt-5">
        <div class="card-body">
            <form action="{{ route('medicalTestsD.update', $medicalTest->id) }}" id="mere" method="post"
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter name"
                            style="font-size: 1.1rem;" value="{{ $medicalTest->name }}">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const form = document.getElementById('mere');
