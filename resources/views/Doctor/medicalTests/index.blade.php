...
@section('content')
    ...
    <div class="patients-container p-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <a href="{{ route('medicalTestsD.create') }}" class="btn btn-primary ms-3"> <!-- Left margin for Add button -->
                Add
            ...
            <table id="myTable" class="table table-striped table-bordered text-center mx-3"> <!-- Margin added -->
                ...
                <tbody>
                    @foreach ($medicalTests as $medicalTest)
                        <tr>
                            <td><strong>{{ $medicalTest->id }}</strong></td>
                            <td><strong>{{ $medicalTest->name }}</strong></td>
                            <td>
                                <a href="{{ route('medicalTestsD.edit', $medicalTest->id) }}"
                                ...
                                <a href="javascript:;" class="btn btn-primary btn-sm p-2 mx-2" data-bs-toggle="modal"
                                    data-bs-target="#deleteSliderModal{{ $medicalTest->id }}">
        ...
        @include('Doctor.medicalTests.delete')
