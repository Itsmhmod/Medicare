...
@section('content')
    ...
    <div class="patients-container p-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <a href="{{ route('prescriptionD.create') }}" class="btn btn-primary ms-3"> <!-- Left margin for Add button -->
                Add
            ...
            <table id="myTable" class="table table-striped table-bordered text-center mx-3"> <!-- Margin added -->
                <thead>
                    <tr>
                        ...
                        <th><strong>Medical Tests</strong></th>
                ...
                <tbody>
                    @foreach ($prescriptions as $prescription)
                        <tr>
                            ...
                            <td><strong>{{ $prescription->doctor->name }}</strong></td>
                            <td><strong>
                                    @foreach ($prescription->treatments as $treatment)
                                        {{ $treatment->name }}
                                        <br>
                                    @endforeach
                                </strong></td>
                            <td><strong>
                                    @foreach ($prescription->MedicalTests as $MedicalTest)
                                        {{ $MedicalTest->name }}
                                        <br>
                                    @endforeach
                                </strong></td>
                            <td>
                                <a href="{{ route('prescriptionD.edit', $prescription->id) }}"
                                ...
                                <a href="javascript:;" class="btn btn-primary btn-sm p-2 mx-2" data-bs-toggle="modal"
                                    data-bs-target="#deleteSliderModal{{ $prescription->id }}">
        ...
        @include('Doctor.prescription.delete')
