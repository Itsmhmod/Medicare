...
@section('content')
    <div class="card mt-5">
        <div class="card-body">
            <form action="{{ route('patientD.update', $patient->id) }}" id="pare" method="post"
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter name"
                            style="font-size: 1.1rem;" value="{{ $patient->name }}">

                    </div>
                    <div class="col-md-6">
                        <label for="phone" class="form-label" style="font-size: 1.2rem;">Phone</label>
                        <input type="text" class="form-control" id="phone" name="phone"
                            placeholder="Enter your phone" style="font-size: 1.1rem;" value="{{ $patient->phone }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="address" name="address"
                            placeholder="Enter your address" style="font-size: 1.1rem;" value="{{ $patient->address }}">

                    </div>
                    <div class="col-md-6">
                        <label for="status" class="form-label" style="font-size: 1.2rem;">Status</label>
                        <input type="text" class="form-control" id="status" name="status"
                            placeholder="Enter your status" style="font-size: 1.1rem;" value="{{ $patient->status }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="age" name="age"
                            placeholder="Enter your age" style="font-size: 1.1rem;" value="{{ $patient->age }}">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const form = document.getElementById('pare');
