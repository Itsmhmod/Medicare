<div id="kt_header" class="header align-items-stretch">
    ...
    <div class="header-brand">
        ...
        <a href="/dashboardDoctor">
            <img alt="Logo" src="{{ asset('home/image/heartbeat-solid.svg') }}" />
        </a>
        <!--end::Logo-->
    ...
    <div class="toolbar">
        ...
        <div class="container-fluid py-6 py-lg-0 d-flex align-items-center justify-content-between">
            ...
            <div class="page-title d-flex flex-column me-5">
                <!--begin::Title-->
                <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0"> Medicare/Doctor</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                    ...
                    <div class="d-flex">
                        ...
                        <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                            ...
                            <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click"
                                ...
                                <img src="{{ asset('Admin/images/doc-6.jpg') }}" alt="user">
                            </div>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                ...
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <form method="POST" id="logout" action="{{ route('doctor.logout') }}">
                                    @csrf
