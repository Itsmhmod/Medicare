...
class DPrescriptionController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('Doctor.prescription.create', compact('treatments', 'medicalTests', 'doctors', 'patients'));
    }
    ...
    public function edit($id)
    {
        ...
        $doctors = Doctor::all();
        $patients = Patient::all();
        return view('Doctor.prescription.edit', compact('prescription', 'treatments', 'medicalTests', 'doctors', 'patients'));
        return redirect()->route('treatmentD.index');
    }
